    ...
    >
      ...
      >
        ...
        <div style={{ padding: "10px 22px 22px", display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            {[
              ...
              return (
                <button
                  ...
                  style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 7, padding: "10px 12px", borderRadius: 10, fontSize: 12.5, fontWeight: 700, background: active ? "#ecfdf5" : "#f1f5f9", color: active ? "#047857" : "#475569", boxShadow: active ? "inset 0 0 0 1.5px " + accent : "none" }}
                >
          ...
          {mediaType === "video" ? (
            <label style={{ display: "flex", alignItems: "center", gap: 7, padding: "11px 14px", background: "#f8fafc", borderRadius: 10, fontSize: 12, fontWeight: 700, color: "#0f172a", cursor: "pointer", boxShadow: "inset 0 0 0 1px #e2e8f0" }}>
          ...
          <label style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <span style={{ fontSize: 11, fontWeight: 700, color: "#64748b" }}>Title</span>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <label style={{ flex: 1, display: "flex", flexDirection: "column", gap: 6 }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: "#64748b" }}>Price (UGX)</span>
            ...
            <label style={{ flex: 1, display: "flex", flexDirection: "column", gap: 6 }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: "#64748b" }}>Delivery (days)</span>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <span style={{ fontSize: 11, fontWeight: 700, color: "#64748b" }}>Category</span>
